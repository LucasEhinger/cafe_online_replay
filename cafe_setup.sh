...
volatile_raw_dir_test="/volatile/hallc/c-lad/${USER}/test_raw"
...
if [[ ifarm_flg -eq 1 ]]; then
	...
	if [[ $fsys == "volatile" ]]; then
		...
		echo "Creating symlink to /cache/hallc/c-lad/raw/"
		...
		base_dir_work="/work/hallc/c-lad/"
